...
<div class="page-header">
  <h2>Produccion<small> - Participación en el PIB</small></h2>
</div>
           ...
           <td>
            <?php
                  $this->widget('zii.widgets.jui.CJuiButton', array(
                        ...
                        'url' => array('ap1Ind2bHist/previo/'.$item->id.''),
             ...
             <td>
                <?php
                  $this->widget('zii.widgets.jui.CJuiButton', array(
                        ...
                        'url' => array('ap1Ind2bHist/update/'.$item->id.''),
                        //'onclick'=>new CJavaScriptExpression('function(){alert("Save button has been clicked"); this.blur(); return false;}'),
                  ));
            ?>
           </td>
             ...
             <td>
                <?php
                  $this->widget('zii.widgets.jui.CJuiButton', array(
                        ...
                        'url' => array('ap1Ind2bHist/excel/'.$item->id.''),
                        //'onclick'=>new CJavaScriptExpression('function(){alert("Save button has been clicked"); this.blur(); return false;}'),
                  ));
            ?>
           </td>
