...
for ($i=1;$i<=$Contar;$i++){
	...
	$_DATOS_EXCEL[$i]['sector']= $objPHPExcel->getActiveSheet()->getCell('B'.$i)->getCalculatedValue();
	$_DATOS_EXCEL[$i]['anio']= $objPHPExcel->getActiveSheet()->getCell('C'.$i)->getCalculatedValue();
	$_DATOS_EXCEL[$i]['valor']= $objPHPExcel->getActiveSheet()->getCell('D'.$i)->getCalculatedValue();
	$_DATOS_EXCEL[$i]['valor']= $objPHPExcel->getActiveSheet()->getCell('E'.$i)->getCalculatedValue();
...
foreach($_DATOS_EXCEL as $campo => $valor){
	$sql = "INSERT INTO ap1Ind2b VALUES ($id,";
