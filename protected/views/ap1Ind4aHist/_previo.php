...
<div id="main_content">
	  	...
	  	<?php
            ...
            ?>
		        ...
		        <p class="table_title default">Indicador Trimestral de la Actividad Economica del Distrito Federal</p>
...
<table class="table_stats">
			        	...
			        	<tr class="cell_label">
			        		<td>Series Originales Indice</td>
			        		<td>Total de la Actividad Economica</td>	
			        		<td>Var Porcentual % respecto al mismo periodo del año anterior</td> 	
...
?>
						...
						<tr class="cell_label">
			        		<td>Series Desestacionalizadas Indice</td>
			        		<td>Total de la Actividad Economica</td>	
			        		<td>Valor Porcentual % respecto al mismo periodo inmediato anterior</td> 	
