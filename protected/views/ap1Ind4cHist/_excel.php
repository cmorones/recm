...
for ($i=1;$i<=$Contar;$i++){
	...
	$_DATOS_EXCEL[$i]['pib']= $objPHPExcel->getActiveSheet()->getCell('C'.$i)->getCalculatedValue();
	$_DATOS_EXCEL[$i]['igae']= $objPHPExcel->getActiveSheet()->getCell('D'.$i)->getCalculatedValue();
	$_DATOS_EXCEL[$i]['itaee']= $objPHPExcel->getActiveSheet()->getCell('E'.$i)->getCalculatedValue();
...
foreach($_DATOS_EXCEL as $campo => $valor){
	$sql = "INSERT INTO ap1Ind4c VALUES ($id,";
