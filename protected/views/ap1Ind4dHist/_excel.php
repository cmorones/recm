...
for ($i=1;$i<=$Contar;$i++){
	...
	$_DATOS_EXCEL[$i]['anio']= $objPHPExcel->getActiveSheet()->getCell('B'.$i)->getCalculatedValue();
	$_DATOS_EXCEL[$i]['trim']= $objPHPExcel->getActiveSheet()->getCell('C'.$i)->getCalculatedValue();
	$_DATOS_EXCEL[$i]['vp']= $objPHPExcel->getActiveSheet()->getCell('D'.$i)->getCalculatedValue();
...
foreach($_DATOS_EXCEL as $campo => $valor){
	$sql = "INSERT INTO ap1Ind4d VALUES ($id,";
