...
/**
 * This is the model class for table "ap1Ind4d".
 *
 * The followings are the available columns in table 'ap1Ind4d':
 * @property integer $id
 ...
 */
class Ap1Ind4d extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_periodo, id_entidad, anio, id_trimestre, user_reg, user_mod', 'numerical', 'integerOnly'=>true),
			array('vp', 'numerical'),
			array('fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_periodo, id_entidad, anio, id_trimestre, vp, fecha_reg, fecha_mod, user_reg, user_mod', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Ap1Ind4d the static model class
	 */
