...
class Ap1Ind1HistController extends Controller {
    ...
    public function actionIndex() {
        ...
        $model= Ap1Ind1Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap1Ind1Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind1Hist']))
            $model->attributes = $_GET['Ap1Ind1Hist'];
     ...
     * @return Ap1Ind1Hist the loaded model
     ...
     * @param Ap1Ind1Hist $model the model to be validated
     */
